...
#include <string> 
#include <conio.h>>
#include <stdlib.h>  // used for making games for memory allocation
#include <ctime>   // converts calender given time

#define WRONGTRIES 5   // 5 chances will be given to the user
...
int main(){
	srand (time(NULL));
	string wordList[5] = {"apple","peach","strawberry", "banana","mango"};
	string word;
	string guessed;
